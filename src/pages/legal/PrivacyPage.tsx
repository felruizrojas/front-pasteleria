const PrivacyPage = () => (
	<main className="container py-5">
		...
		<section className="mb-4">
			...
			<p>
				<strong>Pastelería Mil Sabores</strong>, con domicilio en Concepcion, Chile, es responsable del tratamiento
				de los datos personales recopilados a traves de este sitio web.
			</p>
		</section>
